...
namespace wen.ABPcore
{
    ...
    public class ABPcoreWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ABPcoreWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ABPcoreWebCoreModule).GetAssembly());
        }
    }
}
