...
namespace wen.ABPcore.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    public abstract class ABPcoreRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<ABPcoreDbContext, TEntity, TPrimaryKey>
